...
## installation
      ...
      sudo apt-get update
      sudo apt-get install make gcc libdbd-sqlite3-perl libjson-perl apache2 libcgi-session-perl libipc-system-simple-perl libcarp-always-perl libdata-dumper-simple-perl sqlite3 libsqlite3-dev git
